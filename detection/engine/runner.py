...
from detection.utils.net_utils import save_model, load_network,load_network_specified,load_network_finetune
...
class Runner(object):
    def __init__(self, cfg):
        ...
        if hasattr(self.cfg,'warmup'):
            if cfg.warmup is not None:
                self.warmup_scheduler = build_warmup(self.cfg, self.optimizer)
        else:

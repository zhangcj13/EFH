...
event_backbone ={0: dict(type='SewResnetSDRNN2', 
...
neck={0 : dict(type='DDFPN', # RDDFPN DDFPN
               ...
               dfn = 'f2e',  # [e2f,f2e]
               act="silu",),
     100 : dict(type='KDFNFPN', # RDDFPN DDFPN
               in_channels = [256,512,1024],
               width=width,
               depth=0.33,
               depthwise=False,
...
bbox_heads = {0: dict(type='YOLOX_Head',
            ...
            #             act="silu",
            #             depthwise=False),
            1: dict(type='YOLOX_Head',
                        num_classes=num_classes,
                        width=0.5, # 0.5
                        strides=[8, 16, 32],
                        in_channels=[hidden_dim*2, hidden_dim*2, hidden_dim*2],
                        act="silu",
                        depthwise=False),}[0]
...
no_event_epoch= 130 # 15  max_epoch+1
# freeze_image_backbone_epochs = [30, 50] #[15, 30]

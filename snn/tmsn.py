...
class SNForMemory(nn.Module):
    def __init__(self, dim):
        super().__init__()
        self.sn1 = LIFNode(tau=2., detach_reset=True)
        self.sn2 = LIFNode(tau=2., detach_reset=True)
        ...
        self.v_seq_shifts_lif = LIFNode(tau=2., detach_reset=True, surrogate_function=surrogate.Sigmoid())
